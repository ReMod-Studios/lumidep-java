package io.github.remodstudios.lumidep.client.render.entity

import io.github.remodstudios.lumidep.registerEntityAttributes
...
object LumidepEntities {
    private val REGISTRY = DeferredRegister.create(io.github.remodstudios.lumidep.Lumidep.MOD_ID, Registry.ENTITY_TYPE_KEY)
